...
@Component({
  selector: 'app-internal-loans-validate',
  templateUrl: './internal-loans-validate.component.html',
  styleUrls: ['./internal-loans-validate.component.scss']
})
export class InternalLoansValidateComponent implements OnInit {
